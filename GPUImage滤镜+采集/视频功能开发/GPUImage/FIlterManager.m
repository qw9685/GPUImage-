...
- (GPUImageFilter*)addFilter_Sketch{
...
- (GPUImageFilterGroup*)addFilter_Beautify{
    
    GPUImageBeautifyFilter *filter = [[GPUImageBeautifyFilter alloc] init];
    return filter;
}

- (GPUImageFilter*)addFilter_Gamma{
...
- (GPUImageFilter*)addFilter_ColorInvert{
...
- (GPUImageFilter*)addFilter_Sepia{
...
- (GPUImageFilter*)addFilter_Grayscale{
...
- (GPUImageFilter*)addFilter_Monochrome{
...
- (GPUImageFilter*)addFilter_SobelEdgeDetection{
...
- (GPUImageFilter*)addFilter_XYDerivative{
...
- (GPUImageFilterGroup*)addFilter_SmoothToon{
...
- (GPUImageFilter*)addFilter_ColorPacking{
